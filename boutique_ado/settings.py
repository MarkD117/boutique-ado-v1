...
ALLOWED_HOSTS = ['boutique-ado-md-63e3802e571f.herokuapp.com','localhost']
...
# Logging emails to console for confirmation links
...
if 'USE_AWS' in os.environ:
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'boutique-ado-md'
